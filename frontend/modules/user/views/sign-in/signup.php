...
header .btn-return {
	height:20px;
	line-height:21px;
	background:url(/frontend/web/img/login_btn_return.png) no-repeat;
...
<body>
<header> <a id="gobackElm" class="btn-return" href="javascript:history.back()"></a> <span>注册帐号</span> </header>

<div class="login-wrap">
  <form id="form1">
    <div class="h1"></div>
      <?= Html::beginForm(['order/update', 'id' => 'ff'], 'post', ['enctype' => 'multipart/form-data']) ?>
    <div class="input-box">
     ...
     <?= Html::activeInput('text', $model, 'username', ['placeholder' => '请输入您的姓名', 'class'=>'three-character']) ?>
      ...
      <div class="input-item"> <i class="shouji"></i>
      	...
      	<div  class="input-item"> <i class="mima"></i>
      	   <?= Html::activeInput('password', $model, 'password', ['placeholder' => '密码,6-16个英文字母或数字', 'class'=>'three-character']) ?>
...
<?= Html::endForm() ?>
    ...
    <input  type="hidden" name="hidReturnUrl" value="" />
    <input  type="hidden" value="" />
    <input type="hidden" value="" name="registerSource" />
  </form>
</div>
</body>
</html>
