...
<li><a href="<?= BaseUrl::toRoute('/vip');?>"><img src="/frontend/web/img/a2.png"/><br/><span>会员中心</span></a></li>
<li><a href="<?= BaseUrl::toRoute('my-click/index');?>"><img src="/frontend/web/img/a3.png"/><br/><span>我的点击</span></a></li>
<li><a href="<?= BaseUrl::toRoute('vip/commission');?>"><img src="/frontend/web/img/a4.png"/><br/><span>提取佣金</span></a></li>
</ul>
</div>
<?php $this->endContent() ?>